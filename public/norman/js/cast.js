...
//   guest.webp   처음 쓰는 사람. 시연에서 물건을 처음 만져 보는 사람. 곤란해하는 표정
...
export const CAST = {
  ...
  guest:  { name: "처음 쓰는 사람", tone: "guest",  face: ["#8FB5D9", "#2C3F52"] },
...
export const BROKER = {
  ...
  waiting:
    ...
    "공방에서 「처음 쓰는 사람」으로 한 번 돌려 보고 오시오.",
  looking: "물건을 봅시다. 처음 쓰는 사람이 만진 자국이 남았으니 그걸로 보겠소.",
  reject: v =>
    `이래서는 못 내놓소. 처음 쓰는 사람이 주문대로 해내질 못했소 — ` +
...
export const NORMAN = {
  heard: team =>
    `들었나, ${team}조. 미리 말해 두지 — 저 물건은 이미 멀쩡히 돌아가네. 고장 난 게 아니야.`,
  ...
  beforeGuest: `저 물건을 오늘 처음 만져 보는 사람에게 쥐여 보겠네. ` +
    `우리 눈에는 다 뻔하지. 처음 보는 사람 눈에도 그런지가 문제일세.`,

  toMarket: `내놓을 만하다 싶거든 위에 「앱시장」을 누르게. 거간이 보고 값을 매길 걸세.`,
