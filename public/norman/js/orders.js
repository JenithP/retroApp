...
export const ORDERS = [
  { id: "gym",   name: "운동 기록", ready: true,
    line: "세트와 무게를 적고 쉬는 시간을 재는 화면", bottle: { exec: 1, eval: 3 } },
  { id: "cal",   name: "일정",      ready: false,
    line: "일정을 넣고 끌어서 시간을 옮기는 화면",     bottle: { exec: 1, eval: 1, hidden: 3 } },
  { id: "pay",   name: "송금",      ready: false,
    line: "금액을 넣고 보내는 화면",                  bottle: { exec: 1, eval: 3 } },
  { id: "order", name: "주문 키오스크", ready: false,
    line: "고르고 더하고 결제하는 화면",              bottle: { exec: 3, eval: 1 } },
  { id: "photo", name: "사진 편집", ready: false,
    line: "밝기를 밀고 되돌리는 화면",                bottle: { exec: 1, eval: 2, hidden: 2 } },
  { id: "music", name: "음악 재생", ready: false,
    line: "반복과 섞기를 켜고 끄는 화면",             bottle: { exec: 1, eval: 3 } },
  { id: "wash",  name: "세탁기 판", ready: false,
    line: "빨래 방식을 고르고 작동시키는 화면",       bottle: { exec: 2, eval: 1, culture: 3 } },
  { id: "lock",  name: "문 잠금",   ready: false,
    line: "문이 잠겼는지 보고 여닫는 화면",           bottle: { exec: 1, eval: 3 } },
  { id: "post",  name: "택배 예약", ready: false,
    line: "여러 칸을 차례로 채워 보내는 화면",        bottle: { exec: 3, eval: 2 } },
  { id: "calm",  name: "명상",      ready: false,
    line: "쓸어서 넘기고 눌러서 멈추는 화면",         bottle: { exec: 3, eval: 1 } },
];
