...
const HINTS = {
  ...
  material: ["누는 「나무」라는 묶음 이름을 모릅니다. 누가 주워 올 수 있는 물건 하나를 가리켜 말해 보십시오.",
             "마른 막대 — 밟으면 딱 소리가 나는 그것을 가져오라고 해 보십시오."],
  method:   ["마찰·열 같은 말은 통하지 않습니다. 손으로 무엇을 어떻게 하는지 몸짓으로 설명해 보십시오.",
             "추운 날 손이 시리면 두 손을 어떻게 하나요? 그것을 막대에 해 보라고 하십시오."],
...
export async function chapter1(G) {
  ...
  await untilUnderstood("material", "빨간 것을 부르려면 먼저 무엇이 필요하다고 할까? 누가 가져올 물건 하나를 말해 보자.");
  talk.close();
  ...
  await untilUnderstood("method", "막대를 가지고 어떻게 해야 빨간 것이 생긴다고 할까? 손으로 하는 동작을 알려 주자.");
  ...
  await untilUnderstood("ember", "연기가 나고 작은 빨간 것이 생겼다. 이걸 크게 키우려면 어떻게 하라고 할까?");
