...
export async function chapter1(G) {
  ...
  await untilUnderstood("불이 있으면 고기를 익히고 몸을 데울 텐데. 뭐라고 말할까?", [
    ...
    { t: "「번개가 나무에 떨어지면 생기는 거야.」", kind: "abstract",
      then: () => huh("(갸웃) 번…개…? 그것도 누는 모른다. 반짝이는 돌 사람은 모르는 말만 한다.") },
    { t: "「비 오던 밤에 하늘이 번쩍하고 쾅 소리가 났을 때, 큰 나무가 쓰러지면서 뜨겁고 빨갛게 일렁이던 것 기억나?」",
      kind: "situ",
      then: () => got("(눈이 동그래진다) 하늘 뱀! 하늘 뱀이 나무를 먹었다! 뜨거운 빨간 것!\n누가 봤다. 그리고 무서웠다. 그리고… 따뜻했다!", "joy") },
  ]);
